    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is Pharmacy => {
            ...
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ("string" === typeof input.name || $guard(_exceptionable, {
                ...
                expected: "Timestamp",
                value: input.jsonUpdatedAt
            })) && ("accessible" === input.dummyAccessibility || "inaccessible" === input.dummyAccessibility || "unknown" === input.dummyAccessibility || $guard(_exceptionable, {
                path: _path + ".dummyAccessibility",
                expected: "(\"accessible\" | \"inaccessible\" | \"unknown\")",
                value: input.dummyAccessibility
            }));
